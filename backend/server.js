...
const loadData = async () => {
    try {
        ...
        botState.settings = {
            INITIAL_VIRTUAL_BALANCE: parseFloat(process.env.INITIAL_VIRTUAL_BALANCE),
            MAX_OPEN_POSITIONS: parseInt(process.env.MAX_OPEN_POSITIONS, 10),
            POSITION_SIZE_PCT: parseFloat(process.env.POSITION_SIZE_PCT),
            TAKE_PROFIT_PCT: parseFloat(process.env.TAKE_PROFIT_PCT),
            STOP_LOSS_PCT: parseFloat(process.env.STOP_LOSS_PCT),
            USE_TRAILING_STOP_LOSS: process.env.USE_TRAILING_STOP_LOSS === 'true',
            TRAILING_STOP_LOSS_PCT: parseFloat(process.env.TRAILING_STOP_LOSS_PCT),
            SLIPPAGE_PCT: parseFloat(process.env.SLIPPAGE_PCT),
            MIN_VOLUME_USD: parseFloat(process.env.MIN_VOLUME_USD),
            SCANNER_DISCOVERY_INTERVAL_SECONDS: parseInt(process.env.SCANNER_DISCOVERY_INTERVAL_SECONDS, 10),
            EXCLUDED_PAIRS: process.env.EXCLUDED_PAIRS,
            ...
            LOSS_COOLDOWN_HOURS: parseInt(process.env.LOSS_COOLDOWN_HOURS, 10),
            BINANCE_API_KEY: process.env.BINANCE_API_KEY_ENCRYPTED,
            BINANCE_SECRET_KEY: process.env.BINANCE_SECRET_KEY_ENCRYPTED,
            USE_ATR_STOP_LOSS: process.env.USE_ATR_STOP_LOSS === 'true',
            ATR_MULTIPLIER: parseFloat(process.env.ATR_MULTIPLIER),
            USE_AUTO_BREAKEVEN: process.env.USE_AUTO_BREAKEVEN === 'true',
            BREAKEVEN_TRIGGER_PCT: parseFloat(process.env.BREAKEVEN_TRIGGER_PCT),
            ADJUST_BREAKEVEN_FOR_FEES: process.env.ADJUST_BREAKEVEN_FOR_FEES === 'true',
            TRANSACTION_FEE_PCT: parseFloat(process.env.TRANSACTION_FEE_PCT),
            USE_RSI_SAFETY_FILTER: process.env.USE_RSI_SAFETY_FILTER === 'true',
            RSI_OVERBOUGHT_THRESHOLD: parseInt(process.env.RSI_OVERBOUGHT_THRESHOLD, 10),
            USE_PARTIAL_TAKE_PROFIT: process.env.USE_PARTIAL_TAKE_PROFIT === 'true',
            PARTIAL_TP_TRIGGER_PCT: parseFloat(process.env.PARTIAL_TP_TRIGGER_PCT),
            PARTIAL_TP_SELL_QTY_PCT: parseInt(process.env.PARTIAL_TP_SELL_QTY_PCT, 10),
            USE_DYNAMIC_POSITION_SIZING: process.env.USE_DYNAMIC_POSITION_SIZING === 'true',
            STRONG_BUY_POSITION_SIZE_PCT: parseFloat(process.env.STRONG_BUY_POSITION_SIZE_PCT),
            USE_PARABOLIC_FILTER: process.env.USE_PARABOLIC_FILTER === 'true',
            PARABOLIC_FILTER_PERIOD_MINUTES: parseInt(process.env.PARABOLIC_FILTER_PERIOD_MINUTES, 10),
            PARABOLIC_FILTER_THRESHOLD_PCT: parseFloat(process.env.PARABOLIC_FILTER_THRESHOLD_PCT),
            USE_IGNITION_STRATEGY: process.env.USE_IGNITION_STRATEGY === 'true',
            IGNITION_VOLUME_SPIKE_FACTOR: parseFloat(process.env.IGNITION_VOLUME_SPIKE_FACTOR),
            IGNITION_PRICE_ACCEL_PERIOD_MINUTES: parseInt(process.env.IGNITION_PRICE_ACCEL_PERIOD_MINUTES, 10),
            IGNITION_PRICE_ACCEL_THRESHOLD_PCT: parseFloat(process.env.IGNITION_PRICE_ACCEL_THRESHOLD_PCT),
            IGNITION_MAX_SPREAD_PCT: parseFloat(process.env.IGNITION_MAX_SPREAD_PCT),
