...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const { settingsActivityCounter, refreshData, setSettings, setLatency } = useAppContext();
  ...
  useEffect(() => {
    if (isAuthenticated) {
        ...
        websocketService.onLatencyUpdate(setLatency);
    ...
    return () => {
      ...
      websocketService.onLatencyUpdate(null);
    };
  }, [isAuthenticated, setConnectionStatus, settingsActivityCounter, refreshData, setSettings, setLatency]);
